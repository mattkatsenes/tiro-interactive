...
<!-- Variable list to allow for vague css ishness -->
			<xsl:variable name="small-font"		>8pt</xsl:variable>
			<xsl:variable name="normal-font"	>10pt</xsl:variable>
			<xsl:variable name="large-font"		>12pt</xsl:variable>
			<xsl:variable name="larger-font"		>16pt</xsl:variable>
