...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="make-layout-master-set">
    <fo:layout-master-set>
      <fo:simple-page-master master-name="all-pages-even"
      ...
      <fo:simple-page-master master-name="all-pages-odd"
                             xsl:use-attribute-sets="page">
		...
		<fo:page-sequence-master master-name="document">
	      <fo:repeatable-page-master-alternatives>
	        <fo:conditional-page-master-reference odd-or-even="even"
	          master-reference="all-pages-even"/>
	        <fo:conditional-page-master-reference odd-or-even="odd"
	          master-reference="all-pages-odd"/>
	      </fo:repeatable-page-master-alternatives>
  ...
  <xsl:template match="div">
    ...
    <xsl:choose>
	 ...
	 <!-- Added by Drew Buschhorn - 11/23/2007 - Added a class modifier to fo:block-container-->
        <fo:block-container class="{@class}">
          <xsl:if test="@dir">
          ...
          <xsl:call-template name="process-common-attributes"/>
	 <!-- Added by Drew Buschhorn - 11/23/2007 - Added a class modifier to fo:block-container-->		
          <fo:block start-indent="0pt" end-indent="0pt" class="{@class}">
            <xsl:apply-templates/>
          </fo:block>
        </fo:block-container>
      </xsl:when>
  ...
  <xsl:template match="center">
  	 <!-- Added by Drew Buschhorn - 11/23/2007 - Added a class modifier to fo:block-container-->
    <fo:block text-align="center" class="{@class}">
      <xsl:call-template name="process-common-attributes-and-children"/>
    </fo:block>
  </xsl:template>
  ...
  <xsl:template match="fieldset | dir | menu">
  	 <!-- Added by Drew Buschhorn - 11/23/2007 - Added a class modifier to fo:block-container-->
    <fo:block space-before="1em" space-after="1em" class="{@class}">
      <xsl:call-template name="process-common-attributes-and-children"/>
    </fo:block>
  </xsl:template>
  ...
  <!-- Added by Drew Buschhorn - 11/23/2007 - Added a class modifier to class-->
  ...
  <xsl:template name="process-img">
    <xsl:attribute name="src">
      <xsl:text>url('file:/data01/oscar/internet/htdocs/property/</xsl:text>
